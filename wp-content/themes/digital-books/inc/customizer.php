...
function digital_books_customize_register($wp_customize){
    ...
    $wp_customize->add_setting( 'digital_books_single_page_sidebar_layout', array(
        'default'           => 'No Sidebar',
        'sanitize_callback' => 'digital_books_sanitize_choices'
    ));
    $wp_customize->add_control( 'digital_books_single_page_sidebar_layout', array(
        'section' => 'digital_books_page_settings',
        'type' => 'select',
        'label' => __( 'Single Page Sidebar Position', 'digital-books' ),
        'choices' => array(
            'No Sidebar' => __( 'No Sidebar', 'digital-books' ),
            'Right Side' => __( 'Right Side', 'digital-books' ),
            'Left Side' => __( 'Left Side', 'digital-books' ),
        )
    ));
    ...
    $wp_customize->add_setting( 'digital_books_footer_content_color', array(
        'default' => '',
        'sanitize_callback' => 'sanitize_hex_color'
    ));
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'digital_books_footer_content_color', array(
        'label' => __('Footer Content Color', 'digital-books'),
        'section' => 'digital_books_site_footer_section',
        'settings' => 'digital_books_footer_content_color',
    )));
    ...
    $wp_customize->add_setting( 'digital_books_copyright_text_color', array(
        'default' => '',
        'sanitize_callback' => 'sanitize_hex_color'
    ));
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'digital_books_copyright_text_color', array(
        'label' => __('Copyright Text Color', 'digital-books'),
        'section' => 'digital_books_site_footer_section',
        'settings' => 'digital_books_copyright_text_color',
    )));
