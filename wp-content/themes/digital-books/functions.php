...
function digital_books_widgets_init() {
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Column 4', 'digital-books' ),
		'id'            => 'digital-books-footer4',
		'description'   => '',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h5 class="footer-column-widget-title">',
...
// New menu function start

// add_action( 'digital_books_navigation_action','digital_books_single_post_navigation',30 );
if( !function_exists('digital_books_content_offcanvas') ):

    // Offcanvas Contents
    function digital_books_content_offcanvas(){ ?>
        ...
        <div id="offcanvas-menu">
            <div class="offcanvas-wraper">
                ...
                <div id="primary-nav-offcanvas" class="offcanvas-item offcanvas-main-navigation">
                    <nav class="primary-menu-wrapper" aria-label="<?php esc_attr_e('Horizontal', 'digital-books'); ?>" role="navigation">
                            ...
                            if (has_nav_menu('primary')) {
                                ...
                                wp_list_pages(
                                    array(
                                        ...
                                        'title_li' => false,
                                        'show_toggles' => true,
                                        'walker' => new Digital_Books_Menu_Page(),
                                    )
                                );
                            }
                            ?>
...
add_action( 'digital_books_before_footer_content_action','digital_books_content_offcanvas',30 );


if ( ! function_exists( 'digital_books_sub_menu_toggle_button' ) ) :

    function digital_books_sub_menu_toggle_button( $args, $item, $depth ) {
        ...
        if ( $args->theme_location == 'primary' && isset( $args->show_toggles ) ) {
            ...
            if ( in_array( 'menu-item-has-children', $item->classes ) ) {
                ...
                $args->after .= '<button type="button" class="theme-aria-button submenu-toggle" data-toggle-target="' . esc_attr( $toggle_target_string ) . '" data-toggle-type="slidetoggle" data-toggle-duration="250" aria-expanded="false"><span class="btn__content" tabindex="-1"><span class="screen-reader-text">' . esc_html__( 'Show sub menu', 'digital-books' ) . '</span><i class="fas fa-chevron-down"></i></span></button>';
...
add_filter( 'nav_menu_item_args', 'digital_books_sub_menu_toggle_button', 10, 3 );

// New menu function end

function digital_books_files_setup() {
...
add_action( 'after_setup_theme', 'digital_books_files_setup' );
			...
			<div class="feature-section three-col">
				<div class="col">
					<div class="widgets-holder-wrap">
						...
						<p><?php esc_html_e("If you’re a fan of Digital Books themes, we would greatly appreciate your valuable review of our theme.", "digital-books"); ?></p>
