<?php
    ...
    $digital_books_copyright_content_alignment = get_theme_mod( 'digital_books_copyright_content_alignment','Center');
    ...
    /*------------------ Footer CSS -------------------*/
    $digital_books_footer_content_color = get_theme_mod( 'digital_books_footer_content_color');
    if($digital_books_footer_content_color != ''){
        $digital_books_theme_css .='#colophon, #colophon a, #colophon h5, #colophon .widget #wp-calendar caption {';
            $digital_books_theme_css .='color: '.esc_attr($digital_books_footer_content_color).';';
        $digital_books_theme_css .='}';
    }

    /*------------------ Copyright CSS -------------------*/
    $digital_books_copyright_text_color = get_theme_mod( 'digital_books_copyright_text_color');
    if($digital_books_copyright_text_color != ''){
        $digital_books_theme_css .='#colophon .site-info a, #colophon .site-info span {';
            $digital_books_theme_css .='color: '.esc_attr($digital_books_copyright_text_color).';';
        $digital_books_theme_css .='}';
    }